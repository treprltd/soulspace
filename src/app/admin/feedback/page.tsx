...
function RecommendChip({ value }: { value: string | null }) {
  if (!value) return <span style={{ color: 'rgba(213,226,235,.60)', fontSize: '16px' }}>—</span>
...
function Tag({ label }: { label: string }) {
  return (
    <span style={{
      display: 'inline-block', fontSize: '16px', padding: '2px 7px',
...
const filterBtn = (active: boolean): React.CSSProperties => ({
  padding: '6px 12px', fontSize: '16px', fontFamily: 'var(--font-sans)',
...
const pageBtn = (disabled: boolean): React.CSSProperties => ({
  padding: '7px 14px', fontSize: '16px', fontFamily: 'var(--font-sans)',
  background: 'var(--ink2)', border: '1px solid var(--hairline)',
      ...
      {!notConfigured && !error && (
        <>
          ...
          <div style={{ display: 'flex', gap: '12px', marginBottom: '16px', flexWrap: 'wrap' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'flex-end', gap: '8px', marginBottom: '6px' }}>
                <span style={{
                  fontSize: '39px', fontFamily: 'var(--font-serif)', fontWeight: 300, lineHeight: 1,
                ...
                <span style={{ color: 'var(--mist)', fontSize: '16px', paddingBottom: '4px' }}>/5</span>
              </div>
            ...
            <div style={{
              ...
              {totalRec === 0 ? (
                <div style={{ color: 'var(--mist)', fontSize: '17px' }}>No responses yet</div>
              ) : (
              ...
              {[5, 4, 3, 2, 1].map(n => {
                ...
                return (
                  <div key={n} style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '5px' }}>
                    <span style={{ fontSize: '16px', color: col, width: '14px', textAlign: 'right' }}>{n}★</span>
                    ...
                    <span style={{ fontSize: '16px', color: 'var(--mist)', width: '24px', textAlign: 'right' }}>{ct}</span>
                  </div>
                )
              })}
            </div>
          ...
          <div style={{ display: 'flex', gap: '8px', marginBottom: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <span style={{ fontSize: '16px', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--mist)' }}>
              Rating:
            </span>
            ...
            <>
                    ...
                    <tr style={{ borderBottom: '1px solid var(--hairline)' }}>
                      {['User', 'Date', 'Rating', 'Ease', 'Recommend', 'Comments', ''].map(h => (
                        <th key={h} style={{
                          ...
                          fontSize: '16px', letterSpacing: '0.09em',
                        ...
                        <>
                          ...
                          >
                            ...
                            <td style={{ padding: '11px 14px', maxWidth: '200px' }}>
                              {row.user_email ? (
                                <div style={{ color: 'var(--sand)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontSize: '16px' }}>
                                  {row.user_email}
                                </div>
                              ) : row.guest_email ? (
                                <div>
                                  <span style={{
                                    display: 'inline-block', fontSize: '16px', padding: '1px 5px',
                                  ...
                                  <div style={{ color: 'rgba(245,237,216,.6)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontSize: '16px' }}>
                                    {row.guest_email}
                                  </div>
                                </div>
                              ) : (
                            ...
                            {/* Date */}
                            <td style={{ padding: '11px 14px', color: 'var(--mist)', whiteSpace: 'nowrap', fontSize: '16px' }}>
                            ...
                            <td style={{ padding: '11px 14px', textAlign: 'center', width: '32px' }}>
                              <span style={{
                                color: 'rgba(213,226,235,.65)', fontSize: '16px',
                            ...
                            <tr key={`${row.id}-detail`} style={{ borderBottom: '1px solid var(--hairline)' }}>
                              <td colSpan={7} style={{ padding: '0 14px 16px', background: 'rgba(6,14,24,.5)' }}>
                                <div style={{
                                  ...
                                  {/* Use frequency */}
                                  <div>
                                    <div style={{ fontSize: '16px', letterSpacing: '0.11em', textTransform: 'uppercase', color: 'rgba(213,226,235,.72)', marginBottom: '5px' }}>
                                      Use Frequency
                                    </div>
                                  ...
                                  {row.most_valuable && row.most_valuable.length > 0 && (
                                    <div>
                                      <div style={{ fontSize: '16px', letterSpacing: '0.11em', textTransform: 'uppercase', color: 'rgba(213,226,235,.72)', marginBottom: '6px' }}>
                                        Most Valuable
                                      </div>
                                      <div>
                                  ...
                                  {row.comments && (
                                    <div style={{ gridColumn: '1 / -1' }}>
                                      ...
                                      <p style={{
                                        color: 'rgba(245,237,216,.65)', fontSize: '17px',
                                  ...
                                  <div>
                                    {row.user_id ? (
                                      <>
                                        ...
                                        <span style={{ color: 'rgba(213,226,235,.65)', fontSize: '16px', fontFamily: 'monospace' }}>
                                          {row.user_id}
                                        </span>
                                      </>
                                    ) : row.guest_email ? (
                                      <>
                                        ...
                                        <span style={{ color: 'var(--sand)', fontSize: '16px' }}>
                                          {row.guest_email}
                                        </span>
                                      </>
                                    ) : (
              ...
              {data.pages > 1 && (
                <div style={{ display: 'flex', gap: '8px', marginTop: '16px', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '16px', color: 'var(--mist)' }}>{page} / {data.pages}</span>
